from authentication.serializers import userSerializer,RegisterUserSerializer,Registerserilaizer
...
class Taskserilaizer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ('id','description','name','status','creator','project','affectedTo','startdate','enddate','createdate',)
...
class UpdateTaskserilaizer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ('id','description','name','status','creator','project','affectedTo','startdate','updatedate','enddate')
...
class TaskProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields=['id','description','name','status','creator_id', 'affectedTo_id' ,'startdate','updatedate','enddate','createdate',]
...
class TaskOwnerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields=['id','description','name','status','project_id', 'affectedTo_id' ,'startdate','updatedate','enddate','createdate',]
